...
static void loggerhandler_log(union LoggerHandler * const this, enum LogLevel const level, char const * const msg);
...
void loggerhandler_log(union LoggerHandler * const this, enum LogLevel const level, char const * const msg)
{
    printf("%s\n", msg);
}
