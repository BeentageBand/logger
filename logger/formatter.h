...
union Formatter_Class {
  ...
  struct {
    struct Class Class;
    char const *(*_private format)(union Formatter *const formatter,
                                   enum LogLevel const level,
                                   uint32_t const line_num,
                                   char const *const file_name,
                                   char const *const msg,
                                   va_list const va_args);
  };
};
...
extern void Formatter_populate(union Formatter *const formatter,
                               char const *const facility_name,
                               enum LogLevel const log_level,
                               char const *const format);

extern char const *
Formatter_format(union Formatter *const formatter, enum LogLevel const level,
